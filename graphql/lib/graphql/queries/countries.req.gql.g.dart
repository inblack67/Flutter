...
class _$GfetchCountriesReq extends GfetchCountriesReq {
  ...
  factory _$GfetchCountriesReq(
      ...
      (new GfetchCountriesReqBuilder()..update(updates)).build();
  ...
  _$GfetchCountriesReq._(
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(vars, 'GfetchCountriesReq', 'vars');
    BuiltValueNullFieldError.checkNotNull(
        operation, 'GfetchCountriesReq', 'operation');
    BuiltValueNullFieldError.checkNotNull(
        executeOnListen, 'GfetchCountriesReq', 'executeOnListen');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GfetchCountriesReq')
          ..add('vars', vars)
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'GfetchCountriesReq', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
